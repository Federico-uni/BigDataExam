...
# BERTSCORE
# =========================
def bert_score_metrics(reference: str, candidate: str, lang: str = "en"):
    """
    Calcola BERTScore tra reference e candidate.
    In questo script:
    - reference = contesto recuperato (tradotto in inglese)
    - candidate = risposta generata dal modello
    """
...
def generate_rag_answer(question, embedder, embeddings, chunks, top_k=TOP_K):
    ...
    bert_scores = bert_score_metrics(context_en, answer, lang="en")

    return answer, retrieved, bert_scores, context_en
...
if __name__ == "__main__":
    ...
    for q in questions:
        ...
        answer, retrieved, bert_scores, context_en = generate_rag_answer(q, embedder, embeddings, chunks)
