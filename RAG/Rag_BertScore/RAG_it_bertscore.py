...
OUTPUT_CSV = "C:/Users/Tesisti/Desktop/OUTPUT_IT_Dataset/rag_results_bertscore_IT_DoSampleFALSE_PromptDiverso.csv"
...
# BERTSCORE
# =========================
def bert_score_metrics(reference: str, candidate: str):
    P, R, F1 = bert_score(
        [candidate],
        [reference],
...
def generate_rag_answer(question, embedder, embeddings, chunks, top_k=TOP_K):
    ...
    bert_scores = bert_score_metrics(context_it, answer)

    return answer, retrieved, bert_scores, context_it
...
if __name__ == "__main__":
    ...
    for q in questions:
        ...
        answer, retrieved, bert_scores, context_it = generate_rag_answer(q, embedder, embeddings, chunks)
    ...
    with open(OUTPUT_CSV, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(
            f,
            fieldnames=["question", "answer", "bert_precision", "bert_recall", "bert_f1"]
        )
        writer.writeheader()
